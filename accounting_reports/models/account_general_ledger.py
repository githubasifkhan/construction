...
class report_account_general_ledger(models.AbstractModel):
    ...
    def _get_templates(self):
        ...
        templates['line_template'] = 'accounting_reports.line_template_general_ledger_report'
        return templates
            ...
            if 'account_%s' % (account.id,) in options.get('unfolded_lines') or unfold_all:
                ...
                if offset == 0:
                    domain_lines.append({
                        ...
                        'class': 'o_accounting_reports_initial_balance',
                ...
                if remaining_lines > 0:
                    domain_lines.append({
                        ...
                        'progress': progress,
                        'class': 'o_accounting_reports_load_more text-center',
                        'parent_id': 'account_%s' % (account.id,),
