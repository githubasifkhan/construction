...
class ResPartner(models.Model):
    ...
    def _get_needofaction_fup_lines_domain(self, date):
        # that part of the domain concerns the date filtering and is overwritten in accounting_reports_followup
    ...
    def open_action_followup(self):
        ...
        return {
            ...
            'view_mode': 'form',
            'views': [[self.env.ref('accounting_reports.customer_statements_form_view').id, 'form']],
