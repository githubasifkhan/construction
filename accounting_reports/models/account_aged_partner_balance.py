...
class report_account_aged_partner(models.AbstractModel):
    ...
    def _get_templates(self):
        ...
        templates['main_template'] = 'accounting_reports.template_aged_partner_balance_report'
        try:
            self.env['ir.ui.view'].get_view_id('accounting_reports.template_aged_partner_balance_line_report')
            templates['line_template'] = 'accounting_reports.template_aged_partner_balance_line_report'
        except ValueError:
            pass
        return templates
...
class report_account_aged_receivable(models.AbstractModel):
    ...
    def _get_templates(self):
        ...
        templates['line_template'] = 'accounting_reports.line_template_aged_receivable_report'
        return templates
...
class report_account_aged_payable(models.AbstractModel):
    ...
    def _get_templates(self):
        ...
        templates['line_template'] = 'accounting_reports.line_template_aged_payable_report'
        return templates
