...
class AccountFollowupReport(models.AbstractModel):
    ...
    def _get_lines(self, options, line_id=None):
        ...
        for currency, aml_recs in res.items():
            ...
            for aml in aml_recs:
                ...
                line_num += 1
                columns = [format_date(self.env, aml.date, lang_code=lang_code), date_due, aml.invoice_id.origin, move_line_name, aml.expected_pay_date and aml.expected_pay_date +' '+ aml.internal_note or '', {'name': aml.blocked, 'blocked': aml.blocked}, amount]
                if self.env.context.get('print_mode'):
    ...
    def _get_templates(self):
        ...
        templates['main_template'] = 'accounting_reports.template_followup_report'
        templates['line_template'] = 'accounting_reports.line_template_followup_report'
        return templates
    ...
    def send_email(self, options):
        ...
        if email and email.strip():
            ...
            start_index = body_html.find(b'<span>', body_html.find(b'<div class="o_accounting_reports_summary">'))
    ...
    def print_followups(self, records):
        ...
        return self.env.ref('accounting_reports.action_report_followup').report_action(res_ids)
