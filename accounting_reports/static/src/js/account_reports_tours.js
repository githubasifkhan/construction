odoo.define('accounting_reports.tour', function (require) {
'use strict';
...
Tour.register('account_followup_reports_widgets', {
    test: true,
    url: '/web#action=accounting_reports.action_view_list_customer_statements',
    },
     [
        {
        ...
        },
        {
            ...
            trigger: '.o_accounting_reports_followup_send_mail_button',
            run: 'click'
        },
        {
        ...
        },
        {
            ...
            trigger: '.o_accounting_reports_followup_do_it_later_button',
            run: 'click'
        },
     ]
);
