...
var FollowupFormController = FormController.extend({
    ...
    renderButtons: function ($node) {
        ...
        this.$buttons.on('click',
            '.o_accounting_reports_followup_print_letter_button',
            this._onPrintLetter.bind(this));
        this.$buttons.on('click',
            '.o_accounting_reports_followup_send_mail_button',
            this._onSendMail.bind(this));
        this.$buttons.on('click',
            '.o_accounting_reports_followup_do_it_later_button',
            this._onDoItLater.bind(this));
        this.$buttons.on('click',
            '.o_accounting_reports_followup_done_button',
    ...
    _displayDone: function () {
        this.$buttons.find('button.o_accounting_reports_followup_done_button').show();
    ...
    _displayNextFollowup: function () {
        ...
        this.update(params);
        this.$buttons.find('button.o_accounting_reports_followup_done_button').hide();
        this._checkDone();
    },
    /**
    ...
    _removeHighlightEmail: function () {
        this.$buttons.find('button.o_accounting_reports_followup_send_mail_button')
    ...
    _removeHighlightPrint: function () {
        this.$buttons.find('button.o_accounting_reports_followup_print_letter_button')
            .removeClass('btn-primary').addClass('btn-secondary');
    },
    /**
     * @override
