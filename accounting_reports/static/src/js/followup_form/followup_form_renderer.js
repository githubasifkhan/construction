...
var FollowupFormRenderer = FormRenderer.extend({
    events: _.extend({}, FormRenderer.prototype.events, {
        'click .o_accounting_reports_followup_auto': '_onAuto',
        'click .o_accounting_reports_followup_manual': '_onManual',
        ...
        'click .o_accounting_reports_summary': '_onEditSummary',
    ...
    renderAutoReminder: function (date) {
        this.$('.o_accounting_reports_next_action_date').html(date);
        this.$('.o_accounting_reports_followup_manual').toggleClass('btn-secondary btn-primary');
        this.$('.o_accounting_reports_followup_auto').toggleClass('btn-secondary btn-primary');
        this.$('div.o_accounting_reports_next_action_date_picker').hide();
        this.$('.o_accounting_reports_next_action_date').show();
    },
    /**
    ...
    renderEditSummary: function () {
        ...
        this.$('.o_accounting_reports_summary_edit').show();
        this.$('.o_accounting_reports_summary').hide();
    ...
    renderMailAlert: function () {
        this.$('div.o_accounting_reports_page').prepend(QWeb.render("CustomerStatements.send_mail"));
    },
    /**
    ...
    renderManualReminder: function () {
        this.$('.o_accounting_reports_followup_manual').toggleClass('btn-secondary btn-primary');
        this.$('.o_accounting_reports_followup_auto').toggleClass('btn-secondary btn-primary');
        this.$('div.o_accounting_reports_next_action_date_picker').show();
        this.$('.o_accounting_reports_next_action_date').hide();
    },
    /**
    ...
    renderSavedSummary: function (text) {
        this.$('.o_accounting_reports_summary_edit').hide();
        this.$('.o_accounting_reports_summary').show();
        if (!text) {
    ...
    _renderTagFollowup: function () {
        ...
        $element.find('.o_accounting_reports_summary_edit').hide();
        $element.find('.o_accounting_reports_no_print').removeClass('container');
        this.nextActionDatePicker.appendTo($element.find('div.o_accounting_reports_next_action_date_picker'));
        this.nextActionDatePicker.setValue(moment());
        if (this.state.data.next_action === 'auto'){
            $element.find('div.o_accounting_reports_next_action_date_picker').hide();
            $element.find('.o_accounting_reports_followup_manual').addClass('btn-secondary');
            $element.find('.o_accounting_reports_followup_auto').addClass('btn-primary');
            $element.find('.o_accounting_reports_next_action_date').html(this.state.data.next_action_date_auto);
        } else {
            $element.find('.o_accounting_reports_followup_manual').addClass('btn-primary');
            $element.find('.o_accounting_reports_followup_auto').addClass('btn-secondary');
            $element.find('.o_accounting_reports_next_action_date').hide();
    ...
    _onChangeExpectedDate: function (event) {
        ...
        paymentDatePicker.appendTo($content.find('div.o_accounting_reports_payment_date_picker'));
        var save = function () {
